...
class UserSerializer(serializers.ModelSerializer):
    ...
    type = serializers.CharField(required=False)  # type - необязательный аргумент
    class Meta:
        model = User
...
#
#
# class SignUpSerializers(serializers.ModelSerializer):  # Сериализатор для регистрации
#     password = serializers.CharField(write_only=True, max_length=6)
#
#     class Meta:
#         model = User
#     fields = ['id', 'username','password', 'email', 'date_joined']
#     write_only_fields = ['password']  # Поле только для записи
#
